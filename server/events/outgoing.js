...
client_API.pieceUpdate = function (ws, game_id, pieces, active_grids, next_piece, moves) {
  sendToClient(ws, { type: "piece_update", game_id, pieces, active_grids, next_piece, moves });
};
